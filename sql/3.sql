...
CREATE TABLE `char_class_prereq` (
    ...
    PRIMARY KEY (`id`),
    UNIQUE INDEX `char_class_prereq__child_class_definition` (`child_class_definition`),
    UNIQUE INDEX `char_class_prereq__prereq_class_definition` (`prereq_class_definition`),
...
CREATE TABLE `char_class` (
    ...
    PRIMARY KEY (`id`),
    UNIQUE INDEX `char_class__farm` (`farm`),
    UNIQUE INDEX `char_class__char_class_definition` (`char_class_definition`),
