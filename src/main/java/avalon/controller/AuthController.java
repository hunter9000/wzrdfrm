...
import avalon.interceptor.RolePermissions;
import avalon.model.user.Role;
import avalon.model.user.RoleType;
import avalon.model.user.User;
import avalon.repository.RoleRepository;
import avalon.repository.UserRepository;
import avalon.request.AuthRequest;
import avalon.response.StringResponse;
